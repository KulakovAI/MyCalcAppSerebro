...
public partial class MainPage : ContentPage
{
    ...
    private void ButtonPlus_Clicked(object sender, EventArgs e)
    {
        string str = resultText.Text;
        if (str == "0") resultText.Text = "0";
        else if (str.Contains("+") == false && str.Contains("-") == false && str.Contains("*") == false && str.Contains("/") == false && str.Contains("s") == false) resultText.Text = string.Concat(str, "+");
    }
    ...
    private void ButtonStepen_Clicked(object sender, EventArgs e)
    {
        string str = resultText.Text;
        if (str == "0") resultText.Text = "0";
        else if (str.Contains("+") == false && str.Contains("-") == false && str.Contains("*") == false && str.Contains("/") == false)
            resultText.Text = (Math.Sin((double.Parse(str))*180)/double.Pi).ToString();
    }
